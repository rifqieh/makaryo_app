...
/*
  @admin
  + data - menampilkan daftar pengguna
*/
...
/*
  @user
  + buat akun - membuat akun
  + ubah akun - mengubah deskripsi akun
  + ubah password - mengubah password/lupa password
  + hapus akun - menghapus akun
  + login - sistem mendapatkan Nik pengguna
  + biodata - menampilkan biodata pengguna
*/
